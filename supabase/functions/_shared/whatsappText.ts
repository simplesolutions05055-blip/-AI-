...
//
// These two things outlived the old transport modules: the interactive-message
// type (the simulator still renders real buttons from it) and the length
// splitter (a WhatsApp platform limit). They live here so nothing has to import
// a transport module just for the message shapes.
