    ...
    >
      <LegalSection title="השירות">
        <p>
          ...
          דרך ממשק ניהול, WhatsApp, העלאת קבצים, מסמכים, תמונות, מצגות ותוצרים שיווקיים או תפעוליים.
        </p>
      </LegalSection>
      ...
      <LegalSection title="אחריות המשתמש">
        <LegalList
          items={[
            ...
            'לוודא שתוכן שנשלח ללקוחות, לרשתות חברתיות או לגורמים חיצוניים עומד במדיניות הארגון.',
      ...
      <LegalSection title="תוצרים ובינה מלאכותית">
        <p>
          ...
          שנשלח ללקוחות. המערכת עשויה להשתמש בספקי AI חיצוניים כמו OpenAI או Anthropic Claude
          לפי סוג התוצר והפעולה שבוצעה.
        </p>
      </LegalSection>
