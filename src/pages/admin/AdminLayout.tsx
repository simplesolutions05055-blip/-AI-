...
const USER_ALLOWED_PREFIXES = ['/admin/production', '/admin/quote', '/admin/files', '/admin/holidays', '/admin/annual-planner', '/admin/branding', '/admin/user-settings', '/admin/password', '/admin/meta-connection'];
