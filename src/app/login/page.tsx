...
export default function LoginPage() {
  ...
  return (
    <main className="min-h-screen flex items-center justify-center p-4">
      <form
        onSubmit={onSubmit}
        className="w-full max-w-sm bg-white rounded-2xl shadow-sm border border-[var(--border)] p-6"
      >
        ...
        <input
          ...
          className="w-full mb-4 rounded-lg border border-[var(--border)] px-3 py-2 text-start"
        ...
        <input
          ...
          className="w-full mb-4 rounded-lg border border-[var(--border)] px-3 py-2"
        />
